...
public class RecordStore
{
	...
	private RecordStore(String recordStoreName, boolean createIfNecessary) throws RecordStoreException, RecordStoreNotFoundException
	{
		...
		rmsPath = Mobile.getPlatform().dataPath + "/rms";
	...
	public static void deleteRecordStore(String recordStoreName)
	{
		try
		{
			File fstore = new File(Mobile.getPlatform().dataPath + "/rms/"+recordStoreName);
			fstore.delete();
		}
		catch (Exception e)
		{
...
if (recordId == 1) {
	...
	{
		String rmsPath = Mobile.getPlatform().dataPath + "/rms";
		try
		{
